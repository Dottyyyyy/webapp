  ...
  return (
    <div className="min-w-fit">
      ...
      <div
        ...
        style={{ backgroundColor: "#4EFF56" }}
      >
        {/* Sidebar header */}
        <div className="flex justify-between mb-10 pr-3 sm:px-2 bg-[#333333]">
          {/* Close button */}
          <button
            ref={trigger}
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <ul className="mt-3 bg-[#333333]" style={{ borderRadius: 10, }}>
              {/* Dashboard */}
              <SidebarLinkGroup
                activecondition={
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
                        href="#0"
                        className={`block text-white-800 dark:text-gray-100 truncate transition duration-150 ${pathname === "/" || pathname.includes("dashboard")
                          ? ""
                          : "hover:text-white-900 dark:hover:text-white"
                          }`}
                        onClick={(e) => {
                          e.preventDefault();
                          handleClick();
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavLink
                              ...
                              className={({ isActive }) =>
                                ...
                                (isActive
                                  ? "text-gray-500"
                                  : "text-white-500/90 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200")
                              }
                            >
                              <span style={{ color: 'white' }} className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                Admin Dashboard
                              </span>
                            </NavLink>
                          </li>
